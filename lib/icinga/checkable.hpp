...
private:
	...
	bool IsReachableInt(DependencyType dt = DependencyState, intrusive_ptr<Dependency> *failedDependency = nullptr, int rstack = 0, std::set<Checkable::Ptr>* visited = nullptr) const;
